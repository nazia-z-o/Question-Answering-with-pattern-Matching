...
def trainAvailable(x,y):
    ...
    if x in egarosindur_godhuli:
        if y in egarosindur_godhuli:
            print('egarosindur_godhuli')
            
    if x in egarosindur_provati:
        if y in egarosindur_provati:
            print('egarosindur_provati')
